      ...
      >
        ...
        >
          {isMobile && (
            ...
            >
              <span className="text-white text-base font-medium">Careers</span>
            </motion.div>
          )}
            ...
            <>
              ...
              <div className="w-full relative z-10 mb-8 sm:mb-12 md:mb-16 lg:mb-20">
                <img
                  src="/ai/ai-bg.png"
                  alt="hero_cover"
                  className={`w-full ${isMobile ? 'h-[250px] rounded-tl-[40px]' : 'sm:h-[350px] md:h-[425px] lg:h-[500px] rounded-tl-[70px] sm:rounded-tl-[100px] md:rounded-tl-[140px]'} object-cover z-10 relative`}
                />
              </div>
            </>
          )}
        ...
        {isMobile && (
          <motion.div
            ...
            className="flex justify-center gap-3 mt-4 mb-8"
          >
